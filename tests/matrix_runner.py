...
# Each entry is (tone, label, audio_kind, qwen_prompt, video_prompt).
# audio_kind ∈ {prescribed_speech, general_speech, sound_effects, music}
# — filter via --audio-kinds.
SCENE_TEMPLATES = [
    # === IRONIC ===
    ("ironic", "yoga_road_rage", "general_speech",
    ...
    ("ironic", "asmr_construction", "sound_effects",
    ...
    # === SARDONIC ===
    ("sardonic", "linkedin_parking_lot", "prescribed_speech",
    ...
    ("sardonic", "open_plan_inspirational", "music",
    ...
    ("sardonic", "wedding_no_show", "music",
    ...
    ("comedic", "ball_tackle", "sound_effects",
    ...
    ("comedic", "zoom_meeting", "general_speech",
    ...
    ("absurd", "keynote", "prescribed_speech",
    ...
    ("absurd", "talk_show", "prescribed_speech",
    ...
    ("comedic", "thunderstorm_boom", "sound_effects",
    ...
    ("absurd", "drive_thru_order", "general_speech",
...
def build_prompts_for_subject(subject, scenes_per_tone=None,
    ...
    Filters templates by tone and audio_kind if given.
    """
    out = []
    seen = {}
    for tone, label, audio_kind, qwen_t, video_t in SCENE_TEMPLATES:
...
def report_permutation_space(subjects, per_scene_min, qwen_min):
    ...
    by_tone = {}
    by_audio = {}
    for tone, _, audio_kind, _, _ in SCENE_TEMPLATES:
