...
def create_workflow():
    ...
    workflow["3"] = {
        ...
        "inputs": {
            "text": "cinematic shot of a cyberpunk city with neon lights reflecting on wet pavement, snowing, 4k, highly detailed",
            "clip": ["2", 0]
        }
    }
    ...
    workflow["4"] = {
        "class_type": "CLIPTextEncode",
        "inputs": {
            "text": "low quality, worst quality, deformed, distorted, watermark",
            "clip": ["2", 0]
        }
    }
