...
document.addEventListener('DOMContentLoaded', _applySlopFilters);
    ...
    ws.onmessage = e => {
        ...
        if (d.type === 'new_file') {
            ...
            const modelBadge = model
                ...
                : '';
            let media;
            if (isV) media = `<figure class="bg-black aspect-video flex items-center justify-center"><video controls autoplay muted loop class="w-full h-full object-cover"><source src="/files/${file}"></video></figure>`;
            else if (isWav) media = `<figure class="bg-black aspect-video flex items-center justify-center"><audio controls class="w-full"><source src="/files/${file}"></audio></figure>`;
            else media = `<figure class="bg-black aspect-video flex items-center justify-center"><img src="/files/${file}" class="w-full h-full object-cover" loading="lazy"></figure>`;
            c.innerHTML = `${media}
