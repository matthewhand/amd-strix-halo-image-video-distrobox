...
# Utils
COPY comfyui-scripts/get_wan22.sh /opt
COPY comfyui-scripts/set_extra_paths.sh /opt
COPY comfyui-scripts/get_qwen_image.sh /opt
...
COPY rocm-env-for-triton.sh /etc/profile.d/01-rocm-env-for-triton.sh
