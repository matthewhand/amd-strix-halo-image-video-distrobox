...
The Slopfinity web interface and its associated backend have been broken out into a dedicated guide as we prepare to split the projects. 

👉 **[Slopfinity User Guide & Architecture](README.slopfinity.md)**

*Note: The user guide includes comprehensive documentation on the dashboard's layout, state flows, and features, alongside **UI screenshots generated automatically by our latest CI E2E Playwright runs**.*
